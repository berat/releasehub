...
export function Logo({ href = '/' }: LogoProps) {
  return (
    <a className="logo" href={href} aria-label="ReleaseHub home">
      <span className="mark" aria-hidden="true">
        <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path opacity="0.6" d="M35 93C39.4183 93 43 89.4183 43 85C43 80.5817 39.4183 77 35 77C30.5817 77 27 80.5817 27 85C27 89.4183 30.5817 93 35 93Z" fill="var(--acc)"/>
